...
randlst = []
while (True): #infite loop that lets user input infite objects to list
    item = input('What do you want to add to this list? ')
    randlst.append(item)
    if item.lower() == 'q': #allows user to break infite loop with 'q'
        randlst.remove('q')
        break
print(randlst)
